...
description: "Compare CS2Cap's Free, Starter, Pro, and Quant API tiers by monthly request quota, rate limits, endpoint access, and features like webhooks and analytics."
---
...
- **Pro** unlocks the **Full Market-Data surface** for full visibility across the market,
- **Quant** enables **Advanced Analytics, Arbitrage Scanner + Webhook Support**

Every tier is backed by the same 38-marketplace data network with 5–10 min freshness.
...
| --- | :-: | :-: | :-: |
| `GET /prices` — current lowest asks _(38 providers)_ | ✅ | ✅ | ✅ |
| `GET /bids` — highest buy orders _(11 providers)_ | ✅ | ✅ | ✅ |
...
| `GET /sales` — most recent sales details _(8 providers)_ | — | ✅ | ✅ |
