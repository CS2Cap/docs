...
If your key is compromised or you want to rotate it, use your [API Keys page](https://cs2cap.com/account/api-keys). Reissuing your key:
...
| Code | Status | Meaning |
| --- | --- | --- |
| `AUTH_MISSING_AUTHORIZATION` | `401` | The Authorization header is missing. |
| `AUTH_INVALID_SCHEME` | `401` | The header does not use the Bearer scheme. |
| `AUTH_INVALID_API_KEY_FORMAT` | `401` | The credential is empty or malformed. |
| `AUTH_INVALID_API_KEY` | `401` | The key does not exist. |
