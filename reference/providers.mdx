...
| DMarket | Dupe.fi | ECOSteam |
| HaloSkins | iTrade.gg | LIS-SKINS |
| LOOT.Farm | Mannco.store | Market.CSGO|
| PirateSwap | RapidSkins | ShadowPay |
| SkinBaron | Skinflow | SkinOut |
| SkinPlace | Skinport | Skins.com |
| SkinsMonkey | SkinSwap | Skinvault |
| Steam | Swap.gg | Tradeit.gg |
| WAXPEER | white.market | Youpin898 | 
