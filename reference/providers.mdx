...
description: "Complete list of all 39 CS2Cap provider keys with market types, fee data, health fields, and usage examples for the providers request parameter."
---
...
All 39 supported provider keys:

| Provider key | Provider key | Provider key |
| --- | --- | --- |
| `avanmarket` | `lisskins` | `skinout` |
| `bitskins` | `lootfarm` | `skinplace` |
| `buff163` | `mannco` | `skinport` |
| `buffmarket` | `marketcsgo` | `skinscom` |
| `c5` | `pirateswap` | `skinsmonkey` |
| `csdeals` | `rapidskins` | `skinswap` |
| `csfloat` | `shadowpay` | `skinvault` |
| `csgo500` | `skinbaron` | `steam` |
| `csgoempire` | `skinflow` | `swapgg` |
| `csmoney_m` | — | `tradeit` |
| `csmoney_t` | — | `waxpeer` |
| `cstrade` | — | `whitemarket` |
| `dmarket` | — | `youpin` |
