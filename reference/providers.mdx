...
description: "Complete list of all 41 active CS2Cap provider keys with market types, fee data, health fields, and usage examples for the providers request parameter."
---
...
| Skins.com | SkinsMonkey | SkinSwap - Market |
| SkinSwap - Trade | Skinvault | Steam |
