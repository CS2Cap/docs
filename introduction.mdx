...
| **Buy orders** | [`/bids`](/api-reference/bids), [`/bids/history`](/api-reference/bids#get-/bids/history-—-bid-history) | Highest buy order snapshots and buy-order history from bid-enabled marketplaces |
