...
description: "CS2Cap aggregates prices, buy orders, sales, and analytics from 38 CS2 marketplaces into one unified API. Start querying in minutes."
---

CS2Cap gives you normalized market data from 38 CS2 marketplaces — including BUFF163, CSFloat, Skinport, Steam, and more — through a single REST API. Whether you're building a trading bot, pricing tool, or portfolio tracker, CS2Cap handles the data aggregation so you don't have to.
