...
description: "CS2Cap aggregates prices, buy orders, sales, and analytics from 39 CS2 marketplaces into one unified API. Start querying in minutes."
---

CS2Cap gives you normalized market data from 39 CS2 marketplaces — including BUFF163, CSFloat, Skinport, Steam, and more — through a single REST API. Whether you're building a trading bot, pricing tool, or portfolio tracker, CS2Cap handles the data aggregation so you don't have to.
...
<Steps>
  <Step title="Create an account">
    Sign up at [cs2cap.com](https://cs2cap.com), verify your email address, and generate your API key from the Account page.
  </Step>
  <Step title="Make your first request">
    Pass your key in the `Authorization: Bearer` header and query `/v1/prices` to get live prices for any CS2 item.
  </Step>
