      ...
      <CardContent className="p-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            {highlight && (
              <span className="ml-2 border border-primary/40 bg-primary/10 px-1.5 py-0.5 font-mono text-[9px] tracking-widest text-primary">
                UPGRADE RECOMMENDED
              </span>
            )}
          </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 border-2 border-primary bg-primary px-3 py-2 font-mono text-[11px] font-bold tracking-wider text-primary-foreground brutalist-hover"
          >
            UPGRADE
