...
export const metadata: Metadata = {
  title: "CS2 Containers — Collections & Cases",
  description: "Browse Counter-Strike 2 containers: skins grouped by collection plus every weapon case.",
};
  ...
  return (
    <>
      <main className="container py-8">
        <h1 className="mb-6 font-mono text-2xl font-bold">Containers</h1>
