...
<ParamField query="lookback" type="string">
  Duration shorthand such as `7d` or `30`. Overrides `start` when provided. For `interval=1h`, the window ends at the hour boundary after a 15-minute freshness buffer.
</ParamField>
