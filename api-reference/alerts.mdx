...
curl -sS -X POST \
  ...
  "https://api.cs2c.app/v1/account/alerts"
```
...
curl -sS -X POST \
  ...
  "https://api.cs2c.app/v1/account/alerts/batch"
```
...
curl -sS \
  -H "Authorization: Bearer $CS2C_API_KEY" \
  "https://api.cs2c.app/v1/account/alerts?limit=25&search=AK-47"
```
...
curl -sS -X PATCH \
  ...
  "https://api.cs2c.app/v1/account/alerts/YOUR_ALERT_ID"
```
...
curl -sS \
  -H "Authorization: Bearer $CS2C_API_KEY" \
  "https://api.cs2c.app/v1/account/alerts/events?limit=25"
```
