...
The Portfolio API supports two complementary use cases: **stateless valuation** for one-off item lists you send in the request body, and **saved portfolios** that persist items and transactions under your account for ongoing tracking and historical analysis. Portfolio item limits are 1,000 items for Free accounts, 5,000 for Pro, and 10,000 for Quant — the same limit applies regardless of how items were added.
...
**Tiers:** Free, Pro, Quant · **Rate limit:** Free 20 req/min · Pro 100 req/min · Quant 300 req/min
