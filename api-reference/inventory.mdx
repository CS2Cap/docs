...
const response = await fetch(`${base}/inventory/steam`, {
...
const url = new URL(`${base}/inventory/steam/lookup`);
url.searchParams.set('steam_id', '76561198012345678');
