...
**Tiers:** Free, Pro, Quant · **Auth:** Session JWT or API key · **Rate limit:** Standard per-tier RPM
...
**Tiers:** Free, Pro, Quant · **Auth:** Session JWT or root API key · **Rate limit:** Standard per-tier RPM
