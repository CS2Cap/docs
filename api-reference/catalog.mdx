...
description: "Search the CS2 item catalog, load provider metadata and health status, and fetch live FX rates for currency conversion across 200+ currencies (fiat & crypto)."
---
...
<Note>
The endpoint returns the exchange rate for **234 different currencies**, including cryptocurrencies.
</Note>
