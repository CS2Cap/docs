...
curl -sS \
  ...
  "https://api.cs2c.app/v1/account/webhooks"
```
...
curl -sS \
  -H "Authorization: Bearer $CS2C_API_KEY" \
  "https://api.cs2c.app/v1/account/webhooks/deliveries?limit=25&offset=0"
```
...
curl -sS \
  -H "Authorization: Bearer $CS2C_API_KEY" \
  "https://api.cs2c.app/v1/account/webhooks/deliveries/YOUR_DELIVERY_ID"
```
...
curl -sS -X PATCH \
  ...
  "https://api.cs2c.app/v1/account/webhooks/YOUR_WEBHOOK_ID"
```
...
curl -sS -X POST \
  -H "Authorization: Bearer $CS2C_API_KEY" \
  "https://api.cs2c.app/v1/account/webhooks/YOUR_WEBHOOK_ID/rotate-secret"
```
