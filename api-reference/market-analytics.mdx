...
Returns per-provider daily price history for a single item — one price point per provider per UTC day, spanning years of history up to the present. Built for charting long horizons.
