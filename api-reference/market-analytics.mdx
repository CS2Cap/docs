...
with cs2cap.ApiClient(configuration) as client:
    ...
    response = api.get_arbitrage_opportunities(
        limit=25,
        min_spread_pct=5,
        providers_buy=["avanmarket", "buff163", "buffmarket", "c5", "csfloat", "csdeals", "csgo500", "csgoempire", "csmoney_m"],
        providers_sell=["buff163", "buffmarket", "c5", "csfloat"],
    )
...
const response = await api.getArbitrageOpportunities({
  limit: 25,
  minSpreadPct: 5,
  providersBuy: ["buff163"],
  providersSell: ["csfloat"],
});
