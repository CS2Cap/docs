...
<Steps>
  ...
  <Step title="Set up environment variables">
    ...
    <Tip>
      Generate your API key from the Account page at [cs2cap.com](https://cs2cap.com) after verifying your email address.
    </Tip>
  ...
  <Step title="Common next requests">
    ...
    # Highest buy orders across buy-order-enabled providers (Pro/Quant)
    curl -sS -H "Authorization: Bearer $CS2C_API_KEY" \
    ...
    <Note>
      Endpoints marked **Pro/Quant** require a paid plan. If you're on the Free tier, these requests return a `403` until you upgrade. See [Pricing & Plans](/guides/pricing-plans) for a full endpoint-by-tier breakdown.
    </Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Pricing & plans" icon="credit-card" href="/guides/pricing-plans">
    Compare Free, Pro, and Quant tiers by endpoint access, rate limits, and monthly quotas.
  </Card>
</CardGroup>
